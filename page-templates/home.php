...
<main id="content-area">
    ...
    <div class="column journey">
        <div class="gradient"></div>
        <img class="desktop-column-image" src="<?php echo get_template_directory_uri() . '/inc/img/' ?>orange-bg-logo.svg" alt="">
        <img class="mobile-column-image" src="<?php echo get_template_directory_uri() . '/inc/img/' ?>switchboard-logo-mobile.svg" alt="">
    ...
    <div class="column press">
        <div class="gradient"></div>
        <img class="desktop-column-image" src="<?php echo get_template_directory_uri() . '/inc/img/' ?>purple-bg-logo.svg" alt="">
        <img class="mobile-column-image" src="<?php echo get_template_directory_uri() . '/inc/img/' ?>switchboard-logo-mobile.svg" alt="">
    ...
    <div class="column events">
        <div class="gradient"></div>
        <img class="desktop-column-image" src="<?php echo get_template_directory_uri() . '/inc/img/' ?>blue-bg-logo.svg" alt="">
        <img class="mobile-column-image" src="<?php echo get_template_directory_uri() . '/inc/img/' ?>switchboard-logo-mobile.svg" alt="">
